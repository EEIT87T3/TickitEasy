...
<div align="center">
    ...
    <!-- <form method="post" action="<%= request.getContextPath() %>/UpdateProduct/updateProductById" enctype="multipart/form-data">    -->
    <form method="post" action="${pageContext.request.contextPath}/UpdateProduct/updateProductById" enctype="multipart/form-data">    
        <table>
            ...
            <tr><td>商品圖片</td>
               <!-- <td>
                ...
                <td>
                <img id="preview" src="<%= request.getContextPath() + "/" + product.getProductPic() %>" alt="商品圖片" width="200" style="display:block;" /><br/>
                <input type="file" name="newproductPic" id="productPicFile" accept="image/*" onchange="previewImage()">
                <input type="hidden" name="oldproductPic" value="<%= product.getProductPic() %>">
                -->
                <td>
                <img id="preview" src="<%= request.getContextPath() + "/product/images/" + product.getProductPic() %>" alt="商品圖片" width="200" style="display:block;" /><br/>
                <input type="file" name="newproductPic" id="productPicFile" accept="image/*" onchange="previewImage()">
                <input type="hidden" name="oldproductPic" value="<%= product.getProductPic() %>">
            </td>
            </tr>
